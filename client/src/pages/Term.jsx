...
const Term = () => {
  ...
  return (
    <>
      <nav className="fixed bg-white dark:bg-gray-900  w-full top-0 left-0 border-b border-gray-200 dark:border-gray-600">
      ...
      {!term && (
        <>
        <div className="w-full h-full shadow-lg p-4 bg-slate-300 md:mt-[70px]  mt-[150px]">
         ...
         <div className="px-3 md:px-4 py-4 md:py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between  w-full">
         <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
           © 2023 Lost and Found™. All Rights Reserved.
         </span>
         <div className="flex mt-4  space-x-5 md:justify-center md:items-center md:mt-0">
           <a
             href="#"
      ...
      <div className="px-3 md:px-4 py-4 md:py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between fixed md:top-[67px] top-[150px] w-full z-[-10]">
        <span className="text-sm text-gray-500 dark:text-gray-300 text-start">
          © 2023 Lost and Found™. All Rights Reserved.
        </span>
        <div className="flex mt-4  space-x-5 md:justify-center md:items-center md:mt-0">
          <a
